...
const EMAIL = "prasadpranay2005@gmail.com";

const SOCIALS = [
  {
    name: "Instagram",
    url: "https://www.instagram.com/pranayy.c3/",
  },
  {
    name: "GitHub",
    url: "https://github.com/prasad-pranay",
  },
  {
    name: "LinkedIn",
    url: "https://www.linkedin.com/in/pranay-prasad-/",
  },
];
    ...
    try {
      ...
      setNotification((prev: any) => [
        ...prev,
        {
          ...
          message: "Unable to copy email address.",
        },
      ]);
    }
  };
          ...
          >
            ...
            >
              ...
              <span className="text-[#ff5a36]">
                <HoverWord text="worth " />
                <HoverWord text="shipping." />
              </span>
            </h2>
              ...
              >
                ...
                <span
                  className="
                    ...
                    group-hover:border-[var(--foreground)]/40
                  "
                >
                  {isCopied ? (
                    <Check
          ...
          <div className="mt-12 flex-1">
            <textarea
              ...
              className="
                ...
                tracking-[-0.02em]
                text-[var(--foreground)]
                placeholder:text-[var(--foreground)]/20
                outline-none
                target-text
              "
            />
